   ...
   masterDetailView: SC.MasterDetailView.design({
     ...
     detailView: SC.WorkspaceView.extend({
       ...
       topToolbar: SC.ToolbarView.extend({
         ...
         childViews: "actionsMenu displayModeSegments masterPickerButton welcomeMessageLabel filterPanelButton filterCancelButton tasksSearchField tasksSearchCancelButton".w(),
         classNames: ['title-bar'],
         
         actionsMenu: SC.ButtonView.design(SCUI.DropDown, {
           layout: { centerY: 0, left: 10, height: 24, width: 52 },
           classNames: ['image-button'],
           titleMinWidth: 0,
           hasIcon: YES,
           icon: 'actions-icon',
         ...
         masterPickerButton: SC.ButtonView.extend({
           layout: { left: 170, centerY: 0, height: 24, width: 33 },
           titleMinWidth: 0,
           icon: 'project-icon',
           classNames: ['image-button'],
         ...
         tasksList: SC.ScrollView.design({
          ...
          tasksBottomBar: SC.View.design({
             ...
             summaryView: Tasks.SummaryView.design({
               layout: { centerY: 0, height: 16, centerX: -85, width: 450 },
